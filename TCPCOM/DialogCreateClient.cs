...
namespace TCPCOM
{
    public partial class DialogCreateClient : Form
    {
        public string IPAddress { get; private set; }
        public string Port { get; private set; }

        public DialogCreateClient()
        {
            InitializeComponent();
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请输入对方IP地址！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtIP.Focus();
                return;
            }
            ...
            {
                MessageBox.Show("请输入对方端口！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtPort.Focus();
                return;
            }
        ...
        private void DialogCreateClient_Load(object sender, EventArgs e)
        {
            // 设置默认值
