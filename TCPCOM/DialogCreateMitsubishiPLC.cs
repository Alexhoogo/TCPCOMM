...
namespace TCPCOM
{
    public partial class DialogCreateMitsubishiPLC : Form
    {
        public string IPAddress { get; private set; }
        public string Port { get; private set; }

        public DialogCreateMitsubishiPLC()
        {
            InitializeComponent();
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请输入PLC IP地址！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtIP.Focus();
                return;
            }
            ...
            {
                MessageBox.Show("请输入PLC端口！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtPort.Focus();
                return;
            }
        ...
        private void DialogCreateMitsubishiPLC_Load(object sender, EventArgs e)
        {
            // 设置默认值（三菱PLC默认端口5007）
